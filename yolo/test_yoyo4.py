...
# 加载 YOLO 模型
model_cfg = "./yolo/v4/yolov4-tiny.cfg"  # 配置文件
model_weights = "./yolo/v4/yolov4-tiny.weights"  # 预训练权重
coco_names = "./yolo/v4/coco.names"  # COCO 类别文件
...
# 定义需要检测的类别
target_classes = {"person", "car","bus","bicycle"}  # 只检测人和车
